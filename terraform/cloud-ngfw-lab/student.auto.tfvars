...
region              = "ap-south-1"        # Modify the region as required
ssh-key-name        = "my-key-pair"       # Modify the SSH Key name to SSH Key to the one that you have created for your access. For QwikLab related access, please use the SSH Key that was generated by QwikLab.
